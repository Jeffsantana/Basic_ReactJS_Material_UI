...
//     label: "Registry"
//   },
//   { id: "MODELO", numeric: false, disablePadding: false, label: "Model" },
//   { id: "NUM_SERIE", numeric: false, disablePadding: false, label: "Serial" }
// ];
...
class TablePaginate extends React.Component {
  ...
  handleClick = (event, id) => {
    ...
    this.setState({ selected: [] });
    this.props.onChangeAircraft(id);
  };
                  ...
                  return (
                    <Fragment>
                      ...
                      >
                        ...
                        {/* <ShowMoreButton numSelected={selected.length} /> */}
                      </TableRow>
                    </Fragment>
                  );
                })}
